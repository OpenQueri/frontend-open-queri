...
import { t as require_react_dom } from "./react-dom-CGwiQccO.js";
...
function createMemoryHistory(options = {}) {
	...
	function createMemoryLocation(to, state = null, key, unstable_mask) {
		let location$1 = createLocation(entries ? getCurrentLocation().pathname : "/", to, state, key, unstable_mask);
...
function getHistoryState(location$1, index) {
	return {
		...
		key: location$1.key,
		idx: index,
		masked: location$1.unstable_mask ? {
			pathname: location$1.pathname,
			search: location$1.search,
...
function getUrlBasedHistory(getLocation, createHref2, validateLocation, options = {}) {
	...
	function push(to, state) {
		action = "PUSH";
		let location$1 = isLocation(to) ? to : createLocation(history.location, to, state);
		if (validateLocation) validateLocation(location$1, to);
		index = getIndex() + 1;
		let historyState = getHistoryState(location$1, index);
		let url = history.createHref(location$1.unstable_mask || location$1);
		try {
...
var Link = import_react.forwardRef(function LinkWithRef({ onClick, discover = "render", prefetch = "none", relative, reloadDocument, replace: replace2, unstable_mask, state, target, to, preventScrollReset, viewTransition, unstable_defaultShouldRevalidate, ...rest }, forwardedRef) {
	...
	let maskedHref = null;
	if (unstable_mask) {
		let resolved = resolveTo(unstable_mask, [], location$1.unstable_mask ? location$1.unstable_mask.pathname : "/", true);
	...
	let link = /* @__PURE__ */ import_react.createElement("a", {
		...rest,
		...prefetchHandlers,
		href: (isSpaLink ? maskedHref : void 0) || parsed.absoluteURL || href$1,
