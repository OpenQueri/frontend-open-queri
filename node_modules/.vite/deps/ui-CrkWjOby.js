import { r as __require } from "./chunk-D8D7cWU-.js";

//#region node_modules/@splinetool/runtime/build/ui.js
		...
		return typeof __filename < "u" && (ae = ae || __filename), function(ge = {}) {
			...
			m.ready = new Promise((e, t) => {
				...
				e.Color = function(a, n, u, c) {
					...
					if (a = a.toLowerCase(), a.startsWith("#")) {
						switch (n = 255, a.length) {
							case 9: n = parseInt(a.slice(7, 9), 16);
							case 7:
								var u = parseInt(a.slice(1, 3), 16), c = parseInt(a.slice(3, 5), 16), y = parseInt(a.slice(5, 7), 16);
								break;
							case 5: n = 17 * parseInt(a.slice(4, 5), 16);
							case 4: u = 17 * parseInt(a.slice(1, 2), 16), c = 17 * parseInt(a.slice(2, 3), 16), y = 17 * parseInt(a.slice(3, 4), 16);
						}
				...
				e.MakeImageFromCanvasImageSource = function(a) {
					...
					var c = qe.getContext("2d", { willReadFrequently: !0 });
					...
					a.Id = a.Id || [], a.Id.push(function() {
						...
						a.Paragraph.prototype.getRectsForRange = function(d, A, U, X) {
							...
							return u(this._getRectsForPlaceholders());
			...
			function sn(e, t) {
				...
				if (t.Dd || k(`Cannot pass "${Ot(t)}" as a ${this.name}`), t.Dd.Hd || k(`Cannot pass deleted object as a pointer of type ${this.name}`), !this.ke && t.Dd.Jd.ke && k(`Cannot convert argument of type ${t.Dd.Pd ? t.Dd.Pd.name : t.Dd.Jd.name} to parameter type ${this.name}`), r = Ht(t.Dd.Hd, t.Dd.Jd.Gd, this.Gd), this.le) switch (t.Dd.Ld === void 0 && k("Passing raw pointer to smart pointer is illegal"), this.kf) {
					...
					case 2:
						...
						break;
					default: k("Unsupporting sharing policy");
				}
				return r;
			}
			function ln(e, t) {
			...
			function hn(e, t, r) {
				switch (t) {
					case 0: return r ? function(i) {
						return pe[i];
					} : function(i) {
						return G[i];
					};
					case 1: return r ? function(i) {
						return Ee[i >> 1];
					} : function(i) {
						return Be[i >> 1];
					};
					case 2: return r ? function(i) {
						return w[i >> 2];
					} : function(i) {
						return O[i >> 2];
					};
			...
			var Bn = (e, t, r, i) => {
				...
				function f(v) {
					switch (v.getDay()) {
						case 0: return new Date(v.getFullYear() - 1, 11, 29);
						case 1: return v;
						case 2: return new Date(v.getFullYear(), 0, 3);
						case 3: return new Date(v.getFullYear(), 0, 2);
						case 4: return new Date(v.getFullYear(), 0, 1);
						case 5: return new Date(v.getFullYear() - 1, 11, 31);
						case 6: return new Date(v.getFullYear() - 1, 11, 30);
					}
				}
				function h(v) {
					var M = v.Vd;
...
`,
			...
			dr = jr, be = m.BindingError = class extends Error {
				...
				return e = e(r.call(t, i, { Dd: { value: {
					count: o.count,
					$d: o.$d,
					ee: o.ee,
					Hd: o.Hd,
...
` + i.replace(/^Error(:[^\n]*)?\n/, ""));
			...
			}), q.Sd.push({ value: void 0 }, { value: null }, { value: !0 }, { value: !1 }), q.be = q.Sd.length, m.count_emval_handles = function() {
			...
			var bn = {
				...
				c: function(e, t, r) {
					...
					t = S(t), e = i.constructor, i = Object.create(i.constructor.prototype, {
						value: { value: r },
						constructor: { value: Lt(`${i.name}_${t}`, function() {}) }
					}), e.values[r] = i, e[t] = i;
				},
				T: function(e, t, r) {
					r = ut(r), t = S(t), ye(e, {
				...
				m: function(e, t, r, i, o, s, l, f, h, g, P, E) {
					r = S(r), s = K(o, s), f = K(l, f), g = K(h, g), E = K(P, E), ue([e], [t], function(T) {
						return T = T[0], [new ve(r, T.Gd, !1, !1, !0, T, i, s, f, g, E)];
					});
				},
				S: function(e, t) {
					t = S(t);
				...
				ib: function(e, t) {
					...
					switch (e) {
						case 7939: return r = p.getSupportedExtensions() || [], r = r.concat(r.map(function(i) {
							return "GL_" + i;
						})), r = r.map(function(i) {
							return Qe(i);
						}), r = Rr[e] = r, 0 > t || t >= r.length ? (j(1281), 0) : r[t];
						default: return j(1280), 0;
					}
				},
				Oa: function(e, t) {
...
//# sourceMappingURL=ui-CrkWjOby.js.map