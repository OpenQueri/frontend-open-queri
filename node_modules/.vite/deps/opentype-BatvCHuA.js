//#region node_modules/@splinetool/runtime/build/opentype.js
	...
	for (var e = new pe(), r = 0, t = 0, a = 0, n = 0, s = 0; s < this.commands.length; s++) {
		...
		switch (i.type) {
			...
			case "Z":
				a = r, n = t;
				break;
			default: throw new Error("Unexpected path command " + i.type);
		}
	}
...
var He = typeof WeakMap == "function" && /* @__PURE__ */ new WeakMap(), ze, ka = function(e) {
	if (!ze) {
		ze = {};
...
function Ct(e, r) {
	return e.getInt16(r, !1) + e.getUint16(r + 2, !1) / 65535;
}
function Oa(e, r) {
...
function rn(e, r) {
	return Dt(wt(e, 0, e.byteLength), At, r);
}
function It(e, r, t, a) {
	return Dt(wt(e, r, t), Bt, a);
}
function Wr(e, r, t, a) {
	for (var n = [], s = 0; s < t.length; s += 1) {
		var u = rn(new DataView(new Uint8Array(t[s]).buffer), a);
		u._subrs = [], u._subrsBias = 0, u._defaultWidthX = 0, u._nominalWidthX = 0;
		var o = u.private[0], l = u.private[1];
		if (o !== 0 && l !== 0) {
			var f = It(e, l + r, o, a);
			if (u._defaultWidthX = f.defaultWidthX, u._nominalWidthX = f.nominalWidthX, f.subrs !== 0) u._subrs = ve(e, l + f.subrs + r).objects, u._subrsBias = gr(u._subrs);
			u._privateDict = f;
		}
		n.push(u);
	}
...
function _r(e, r, t) {
	...
	function D() {
		o.length % 2 !== 0 && !f && (R = o.shift() + y), l += o.length >> 1, o.length = 0, f = !0;
	}
	function L(F) {
		for (var G, Y, Z, j, $, M, N, W, _, V, H, X, A = 0; A < F.length;) {
			...
			switch (A += 1, q) {
				...
				case 12:
					switch (q = F[A], A += 1, q) {
						...
						case 37:
							...
							break;
						default: console.log("Glyph " + r.index + ": unknown operator 1200" + q), o.length = 0;
					}
					break;
				case 14:
				...
				case 31:
					...
					break;
				default: q < 32 ? console.log("Glyph " + r.index + ": unknown operator " + q) : q < 247 ? o.push(q - 139) : q < 251 ? (G = F[A], A += 1, o.push((q - 247) * 256 + G + 108)) : q < 255 ? (G = F[A], A += 1, o.push(-(q - 251) * 256 - G - 108)) : (G = F[A], Y = F[A + 1], Z = F[A + 2], j = F[A + 3], A += 4, o.push((G << 24 | Y << 16 | Z << 8 | j) / 65536));
			}
		}
	}
...
function sn(e, r, t, a) {
	t.tables.cff = {};
	var i = ve(e, ve(e, en(e, r).endOffset, k.bytesToString).endOffset), u = ve(e, i.endOffset, k.bytesToString);
	t.gsubrs = ve(e, u.endOffset).objects, t.gsubrsBias = gr(t.gsubrs);
	...
	if (t.tables.cff.topDict = f, f._privateDict && (t.defaultWidthX = f._privateDict.defaultWidthX, t.nominalWidthX = f._privateDict.nominalWidthX), f.ros[0] !== void 0 && f.ros[1] !== void 0 && (t.isCIDFont = !0), t.isCIDFont) {
		...
		h += r;
		var d = Wr(e, r, ve(e, h).objects, u.objects);
		f._fdArray = d, p += r, f._fdSelect = nn(e, p, t.numGlyphs, d.length);
	}
	var x = r + f.private[1], m = It(e, x, f.private[0], u.objects);
	if (t.defaultWidthX = m.defaultWidthX, t.nominalWidthX = m.nominalWidthX, m.subrs !== 0) t.subrs = ve(e, x + m.subrs).objects, t.subrsBias = gr(t.subrs);
...
function dn(e, r) {
	...
	return n.charset = t.header.sizeOf() + t.nameIndex.sizeOf() + t.topDictIndex.sizeOf() + t.stringIndex.sizeOf() + t.globalSubrIndex.sizeOf(), n.encoding = 0, n.charStrings = n.charset + t.charsets.sizeOf(), n.private[1] = n.charStrings + t.charStringsIndex.sizeOf(), f = Vr(n, l), t.topDictIndex = qr(f), t;
}
var Gt = {
	parse: sn,
	make: dn
...
Ue[6] = function(r) {
	if (r.substFormat === 1) return new b.Table("chainContextTable", [{
		name: "substFormat",
		type: "USHORT",
		value: r.substFormat
	}, {
		...
		return new b.Table("chainContextTable", a);
	}
...
function Wn(e, r) {
	...
	for (var n = t.parseULong(), s = {}, i = 0; i < n; i++) {
		var u = t.parseTag(), o = t.parseULong(), l = t.parseULong();
		s[u] = Fe.UTF8(e, r + o, l);
	}
	return s;
}
...
function qn(e) {
	...
	var R = Nt.make({
		...
		ulCodePageRange1: 1,
		sxHeight: Kr(e, "xyvw", { yMax: Math.round(S.ascender / 2) }).yMax,
	...
	for (var rr = jt(q), ca = Er(rr.encode()), tr = rr.fields, Ar = !1, Ge = 0; Ge < tr.length; Ge += 1) if (tr[Ge].name === "head table") {
...
Ae.prototype = {
	...
	getGlyphClass: function(e, r) {
		switch (e.format) {
			case 1: return e.startGlyph <= r && r < e.startGlyph + e.classes.length ? e.classes[r - e.startGlyph] : 0;
			case 2:
				var t = jr(e.ranges, r);
...
K.prototype.getFeature = function(e, r, t) {
	...
	switch (e) {
		case "aalt":
		case "salt": return this.getSingle(e, r, t).concat(this.getAlternates(e, r, t));
		case "dlig":
		case "liga":
		case "rlig": return this.getLigatures(e, r, t);
		case "ccmp": return this.getMultiple(e, r, t).concat(this.getLigatures(e, r, t));
		case "stch": return this.getMultiple(e, r, t);
	}
};
K.prototype.add = function(e, r, t, a) {
	...
	switch (e) {
		case "aalt":
		case "salt": return typeof r.by == "number" ? this.addSingle(e, r, t, a) : this.addAlternate(e, r, t, a);
		case "dlig":
		case "liga":
		case "rlig": return this.addLigature(e, r, t, a);
		case "ccmp": return r.by instanceof Array ? this.addMultiple(e, r, t, a) : this.addLigature(e, r, t, a);
	}
};
function Zn() {
...
function ra(e) {
	...
	for (var t = Kn(e), a = 0; a < t.length; ++a) {
		...
		for (var l = 0; l < n.length; ++l) if (s = i, i = u, u = n[(l + 1) % n.length], i.onCurve) r.lineTo(i.x, i.y);
			...
			var h = u;
			s.onCurve || ((i.x + s.x) * .5, (i.y + s.y) * .5), u.onCurve || (h = {
				x: (i.x + u.x) * .5,
				y: (i.y + u.y) * .5
...
function Jn(e, r, t, a) {
	for (var n = new ue.GlyphSet(a), s = 0; s < t.length - 1; s += 1) {
		var i = t[s];
		i !== t[s + 1] ? n.push(s, ue.ttfGlyphLoader(a, s, ea, e, r + i, ta)) : n.push(s, ue.glyphLoader(a, s));
	}
	return n;
}
function jn(e, r, t, a) {
...
var ua = function(e) {
	...
	setRelative: function(e, r, t, a, n) {
		...
		var s = n ? r.xo : r.x, i = n ? r.yo : r.y, u = s + t * a.x;
		e.y = i + t * a.y + a.normalSlope * (e.x - u);
	},
...
function de(e, r) {
	switch (this.env = e, this.stack = [], this.prog = r, e) {
		...
		case "prep": this.fv = this.pv = this.dpv = oe, this.round = oa;
	}
}
...
function T(e, r, t, a, n, s) {
	var i = s.stack, u = e && i.pop(), o = i.pop(), l = s.rp0, f = s.z0[l], h = s.z1[o], p = s.minDis, c = s.fv, d = s.dpv, x, m = x = d.distance(h, f, !0, !0), y = m >= 0 ? 1 : -1, C;
	m = Math.abs(m), e && (C = s.cvt[u], a && Math.abs(m - C) < s.cvCutIn && (m = C)), t && m < p && (m = p), a && (m = s.round(m)), c.setRelative(h, f, y * m, d), c.touch(h), exports.DEBUG && console.log(s.step, (e ? "MIRP[" : "MDRP[") + (r ? "M" : "m") + (t ? ">" : "_") + (a ? "R" : "_") + (n === 0 ? "Gr" : n === 1 ? "Bl" : n === 2 ? "Wh" : "") + "]", e ? u + "(" + s.cvt[u] + "," + C + ")" : "", o, "(d =", x, "->", y * m, ")"), s.rp1 = s.rp0, s.rp2 = o, r && (s.rp0 = o);
}
na = [
	et.bind(void 0, le),
	et.bind(void 0, oe),
...
B.prototype.insertToken = function(e, r, t) {
	...
	}) ? (this.tokens.splice.apply(this.tokens, [r, 0].concat(e)), t || this.dispatch("insertToken", [e, r]), e) : { FAIL: "insertToken: invalid token(s)." };
};
B.prototype.registerModifier = function(e, r, t) {
	this.events.newToken.subscribe(function(a, n) {
		var s = [a, n], i = r === null || r.apply(this, s) === !0, u = [a, n];
		if (i) {
...
function Pe(e, r) {
	if (!e) return -1;
	switch (r.format) {
		case 1: return r.glyphs.indexOf(e);
		case 2:
...
function Di(e, r) {
	return Pe(e, r.coverage) === -1 ? null : e + r.deltaGlyphId;
}
function Ai(e, r) {
...
function Bi(e, r) {
	...
	if (h) for (var c = 0; c < r.lookupRecords.length; c++) for (var d = r.lookupRecords[c], x = d.lookupListIndex, m = this.getLookupByIndex(x), y = 0; y < m.subtables.length; y++) {
		var C = m.subtables[y], S = this.getLookupMethod(m, C);
		if (this.getSubstitutionType(m, C) === "12") for (var O = 0; O < a.length; O++) {
			var L = S(e.get(O));
			L && p.push(L);
		}
	}
...
function Ii(e, r) {
	...
	for (var n, s = r.ligatureSets[a], i = 0; i < s.length; i++) {
		...
		for (var u = 0; u < n.components.length; u++) {
			if (e.lookahead[u] !== n.components[u]) break;
...
J.prototype.getScriptFeaturesIndexes = function(e) {
	...
	for (var t = this.font.tables.gsub.scripts, a = 0; a < t.length; a++) {
		...
		if (s) for (var i = 0; i < s.length; i++) {
			var u = s[i];
			if (u.tag === e) return u.langSys.featureIndexes;
		}
	}
...
J.prototype.getSubstitutionType = function(e, r) {
	return e.lookupType.toString() + r.substFormat.toString();
};
J.prototype.getLookupMethod = function(e, r) {
	var t = this;
	switch (this.getSubstitutionType(e, r)) {
		case "11": return function(n) {
			return Di.apply(t, [n, r]);
		};
		case "12": return function(n) {
			return Ai.apply(t, [n, r]);
		};
		case "63": return function(n) {
			return Bi.apply(t, [n, r]);
		};
		case "41": return function(n) {
			return Ii.apply(t, [n, r]);
		};
		case "21": return function(n) {
			return Mi.apply(t, [n, r]);
		};
		default: throw new Error("lookupType: " + e.lookupType + " - substFormat: " + r.substFormat + " is not yet supported");
	}
};
J.prototype.lookupFeature = function(e) {
	...
	if (!a) return /* @__PURE__ */ new Error("font '" + this.font.names.fullName.en + "' doesn't support feature '" + e.tag + "' for script '" + e.script + "'.");
...
function gt(e, r) {
	return new re(e.map(function(a) {
...
function ao() {
	...
	if (!!this.featuresTags.hasOwnProperty("arab")) {
		wr.call(this);
		this.tokenizer.getContextRanges("arabicWord").forEach(function(a) {
			Qi.call(e, a);
		});
	}
}
function no() {
	...
	if (!!this.featuresTags.hasOwnProperty(r)) {
		if (this.featuresTags[r].indexOf("rlig") !== -1) {
			wr.call(this);
			this.tokenizer.getContextRanges("arabicWord").forEach(function(n) {
				Ki.call(e, n);
			});
		}
	}
...
function so() {
	var e = this, r = "latn";
	if (!!this.featuresTags.hasOwnProperty(r)) {
		if (this.featuresTags[r].indexOf("liga") !== -1) {
			wr.call(this);
			this.tokenizer.getContextRanges("latinWord").forEach(function(n) {
				eo.call(e, n);
			});
		}
	}
...
function w(e) {
	...
	}, this.unitsPerEm = e.unitsPerEm || 1e3, this.ascender = e.ascender, this.descender = e.descender, this.createdTimestamp = e.createdTimestamp, this.tables = Object.assign(e.tables, { os2: Object.assign({
	...
	}, e.tables.os2) })), this.supported = !0, this.glyphs = new ue.GlyphSet(this, e.glyphs || []), this.encoding = new Ot(this), this.position = new Be(this), this.substitution = new K(this), this.tables = this.tables || {}, this._push = null, this._hmtxTableData = {}, Object.defineProperty(this, "hinting", { get: function() {
...
w.prototype.toArrayBuffer = function() {
	for (var r = this.toTables().encode(), t = new ArrayBuffer(r.length), a = new Uint8Array(t), n = 0; n < r.length; n++) a[n] = r[n];
	return t;
};
...
var bo = { parse: xo }, te = new Array(10);
te[1] = function() {
	var r = this.offset + this.relativeOffset, t = this.parseUShort();
	if (t === 1) return {
		posFormat: 1,
...
function Co(e) {
	var r = {};
	e.skip("uShort");
	e.parseULong() > 1 && console.warn("Only the first kern subtable is supported."), e.skip("uLong");
	var n = e.parseUShort() & 255;
...
function Dr(e, r) {
	r = r ?? {};
	var t, a, n = new w({ empty: !0 }), s = new DataView(e, 0), i, u = [], o = k.getTag(s, 0);
...
function Bo(e, r, t) {
	t = t ?? {};
	var n = typeof window > "u" && !t.isUrl ? wo : Do;
...
function Io(e, r) {
	return Dr($t(Ne().readFileSync(e)), r);
}
...
//#endregion
export { ne as Bidi, pe as BoundingBox, w as Font, Q as Glyph, P as Path, k as _parse, Ho as default, Bo as load, Io as loadSync, Dr as parse };
//# sourceMappingURL=opentype-BatvCHuA.js.map